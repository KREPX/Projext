<div x-data="{ isOpen: true }" @click.away="isOpen = false">
    <div class="top-search">
        <select wire:model="option">
            <option selected="selected" value="3">ภาพยนตร์</option>
            <option value="1">ซีรีส์</option>
            <option value="2">นักแสดง</option>
        </select>
        <input wire:model.debounce.500ms="search" type="text" placeholder="ค้นหาภาพยนตร์ ซีรีส์ หรือคนดังที่คุณกำลังมองหา" @focus="isOpen = true" @keydown.escape.window="isOpen = false" @keydown.shift.tab="isOpen = false">
    </div>
